...
export default function CreateProduct({ close, userid }: any) {
    ...
    const [ createProd, { data, error } ] = useMutation(createProducts)
    ...
    return (<div className={styles.container}>
        {
            data && message ? <div className={styles.message}>
                <Message label='Success' message='You successfully created a product' status='success' close={setMessage} />
            </div> : null
        }
        {
            error && message ? <div className={styles.message}>
                <Message label='Error' message='All input should not be empty' status='error' close={setMessage} />
            </div> : null
        }
            ...
            <form onSubmit={onCreateProducts}>
                <div className={styles.createInfo}>
                    <input type="text"
                        ...
                        placeholder='Product title' value={create.title} onChange={e => setCreate({ ...create, title: e.target.value })} />
